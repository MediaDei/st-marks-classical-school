...
<section class="apply">
	...
	<div class="box grid">
		<h4>Apply</h4>
		<div class="grid-1-2">
			<img src="<?php bloginfo('template_url'); ?>/images/_seal.png" alt="Student">
		</div>
		...
		<a class="button"href="<?php bloginfo('template_url'); ?>/temp-files/Application%20for%20Admission3.pdf">
