...
<section class="section-banner">
	<img src="<?php bloginfo('template_url'); ?>/images/classical__banner.jpg" class="main-banner" alt="Classical Page banner"/>
</section>


<section class="classical">
	<h2 class="section-title cl-classical-education">
		Classical Education
		<span class="extra italic">What is it<span style="font-size:1.3em">?</span></span>
	</h2>
	...
	<div class="foundation">
		...
		<div>
		<div class="grid-66">
			<div class="title italic">Grammar</div>
		...
		<div>
		<div class="grid-66">
			<div class="title italic"><span class="italic">Rhetoric</span>&mdash;An Essential Skill</div>
		...
		<h3 class="sub-title space inspired">
		...
		<p class="after"><span class="smallcaps">Finally</span>, <span class="italic">Integration</span> between subjects presented with a Christian worldview ties the world together. Math, science, philosophy, and history are interwoven in a way that relates all subjects to the whole. As students <span class="italic">Integrate</span> subjects, scriptural truth is integrated as well. Classicism provides this perspective unlike any other form of education.</p>
...
<section class="classical main-section">
	...
	<h2 class="section-title cl-lost-content">
		The Lost Content
		<span class="extra italic">If it works, don't fix it.</span>
	</h2>
...
<section class="classical">
	<h2 class="section-title cl-power-of-latin">
		The Power of Latin
		<span class="extra italic">SATs & standardized testing.</span>
	</h2>

	<div class="latin">

		<div class="text-graph">
			<p class="first">According to those who administer the SAT, students who take 2 years of Latin score on average 152 points higher on their SATs.</p>
		...
		<p style="text-align:center; margin:60px 0 20px; font-size:1.1em">Why is Latin such a valuable academic tool?</p>
 
		<div class="list italic">
			<div class="num">1</div><p>Latin is a powerful vocabulary builder. Over half of English comes from Latin, because often five or ten English words may stem from a single Latin root. By learning Latin, students are capable of grasping many English words that they’ve never heard.</p>

			<div class="num">2</div><p>English is a compound of other languages and therefore has many exceptions—its structure is hard to follow. Latin’s syntax and grammar can be considered an excellent “ideal” language, and its lessons equip the student to better write in English.</p>

			<div class="num">3</div><p>Training in Latin also gives the student the foundation for learning other languages like French, Spanish, Portuguese, Italian, and Romanian. Perhaps 80% of each of these languages derives from Latin.</p>

			<div class="num">4</div><p>Professional careers like Law and Medicine, which require precision in language, have Latin as their base for technical terms and names. Students of Latin are readily prepared for these professions.</p>
		</div>
	</div>
</section>
